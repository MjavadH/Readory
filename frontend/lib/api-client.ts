...
export const apiClient = {
  async request<TResponse = unknown, TBody = unknown>(path: string, options: ApiRequestOptions<TBody> = {}) {
    const { method = "GET", query, headers, body, credentials = "include", signal, cache, next } = options
  ...
  patch<TResponse = unknown, TBody = unknown>(path: string, body?: TBody, options?: ApiRequestOptions) {

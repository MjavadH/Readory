    ...
    return (
        <Link href={url}>
            ...
            >
                ...
                <div className="aspect-3/4 rounded-2xl overflow-hidden bg-muted mb-4 relative z-10 shadow-lg group-hover:translate-y-[-4px] transition-transform duration-500">
                    <Image

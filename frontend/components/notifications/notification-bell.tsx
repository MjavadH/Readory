    ...
    return (
        ...
        />
            ...
            <div className="min-w-0 flex-1">
                <p className={cn("truncate text-sm leading-snug", isUnread ? "font-semibold text-foreground" : "font-medium text-foreground/80")}>
                    {item.title}
                </p>
            ...
            {/* Time */}
            <span className="shrink-0 self-start pt-0.5 text-[10px] tabular-nums text-muted-foreground/60">{time}</span>
        </motion.a>
    )
}
    ...
    return (
        ...
        >
            ...
            <div className="space-y-1">
                ...
                <p className="max-w-50 text-xs leading-relaxed text-muted-foreground">{t("noNotificationsDesc")}</p>
            </div>
        </motion.div>
    )
}

      ...
      <div className="grid gap-4 grid-cols-1 lg:grid-cols-3">
        ...
        >
          <Card className="h-full">
            ...
            <CardContent>
              <ChartContainer config={chartConfig} className="h-55 w-full sm:h-65 lg:h-70">
          ...
          <Card className="h-full">
            ...
            <CardContent className="space-y-3">
              {data.topSpenders.length === 0 && (
                <p className="py-6 text-center text-sm text-muted-foreground">{t('NoSpenders')}</p>
              )}
    ...
    >
      <Card className="h-full">
        <CardContent className="p-4">
          ...
          <div className="mt-2 truncate text-lg font-bold tabular-nums sm:text-xl">{value}</div>
        </CardContent>
      </Card>
    </motion.div>
  );

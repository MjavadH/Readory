    ...
    <div className="space-y-10 pb-12">
      <section className="flex flex-col md:flex-row md:items-center justify-between gap-6 px-2">
        <div className="space-y-1">
          ...
          <p className="text-muted-foreground font-medium text-lg ms-16">{t('DetailedHistory')}</p>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="text-4xl font-extrabold text-foreground">
              {t('Amount', {
                ...
                Amount: data?.balance.toFixed(2) || 0,
              })}
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div className="text-4xl font-extrabold text-red-500">
              ...
              {t('Amount', {
                CurrencySymbols: g('CurrencySymbols'),
                Amount: data?.totals.withdrawals || 0,
              })}
            </div>
          </div>
        </motion.div>
      ...
      <div
        ...
        className="bg-card border border-border rounded-[2.5rem] p-8 shadow-xl shadow-black/5 overflow-x-auto"
      >

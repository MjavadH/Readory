      ...
      {error && (
        <Card className="border-destructive/40 bg-destructive/5">
          <CardContent className="flex items-start gap-3 p-4 text-sm text-destructive">
            ...
            <div className="min-w-0 flex-1 wrap-break-word">{getApiErrorMessage(error)}</div>
            <Button size="sm" variant="outline" onClick={() => mutate()} className="shrink-0">
              {t('Refresh')}
            </Button>
          </CardContent>
        </Card>
                ...
                <CardContent className="grid gap-3 p-4 text-sm sm:grid-cols-2">
                  <div className="flex items-start gap-2">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="truncate">{new Date(detail.createdAt).toLocaleString()}</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-2">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="truncate">{detail.actorName ?? detail.actorId ?? '—'}</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-2">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="truncate font-mono text-xs">{detail.ipAddress ?? '—'}</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-2 sm:col-span-2">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="truncate font-mono text-xs">{detail.requestId ?? '—'}</div>
                    </div>
                  </div>
                  {detail.userAgent && (
                    <div className="flex items-start gap-2 sm:col-span-2">
